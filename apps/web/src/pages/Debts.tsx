...
export default function Debts() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {/* List */}
      <div className="card">
        <h2 className="text-lg font-semibold text-slate-900 mb-4">Dettes fournisseurs</h2>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12">
            <p className="text-slate-500">Aucune dette trouvee</p>
          </div>
        ) : (
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1 flex-wrap">
                        <p className="font-medium text-slate-900">{getSupplierName(d.supplier)}</p>
                    ...
                    <div className="ml-4 text-right">
                      <p className="text-lg font-bold text-slate-900">{formatCurrency(d.amount)}</p>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-white/80 mt-1">
                    {getSupplierName(paymentModal.supplier)}
                  </p>
                </div>
                <button
