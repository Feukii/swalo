...
Index de la documentation du projet SWALO - Mini-ERP pour commerces de detail en Afrique centrale.
...
- [Cahier des charges unifie](specs/cahier-des-charges-unifie.md) - Specification complete du projet
- [Implementation Plan](specs/implementation-plan.md) - Plan d'implementation

---

## Architecture

- [Overview](architecture/overview.md) - Architecture globale du projet

---

## Design

- [Charte couleurs](design/charte-couleurs.md) - Palette de couleurs et theming
- [Prix historises](design/prix-historises.md) - Design du systeme de prix

---

## References

- [Codes PIN](reference/codes-pin.md) - Codes PIN de test
- [Dev Notes](reference/dev-notes.md) - Notes de developpement
...
- Fichiers en **kebab-case** (minuscules avec tirets)
- Noms descriptifs
- Extension `.md` pour tous les documents
