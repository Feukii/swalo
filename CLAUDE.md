...
│   └── features-catalog.md  # Exhaustive features catalog (MUST be kept up-to-date)
...
This file is the **single source of truth** for all SWALO features. It lists every feature with:

- Description and purpose
- Supported platforms (Mobile, Web, API, Offline)
- Module classification (Core, Extended, Premium)
- Key files and API endpoints
- Implementation status

**MANDATORY**: When adding, modifying, or removing a feature, Claude MUST update `docs/specs/features-catalog.md` accordingly. This includes:

- Adding new features to the appropriate section
- Updating platform support when a feature is ported to a new platform
- Moving features from "Planned" to their proper section once implemented
- Updating the changelog at the bottom of the file
